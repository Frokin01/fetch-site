...
async function updateHTML() {
  console.log(
    `[${new Date().toLocaleString("ru-RU")}] Начало обновления данных...`
  );
  ...
  console.log(
    `[${new Date().toLocaleString("ru-RU")}] HTML файл успешно обновлен!`
  );
}
...
// Устанавливаем интервал обновления каждые 10 минут (600000 мс)
setInterval(updateHTML, 10 * 60 * 1000);

console.log("Генератор запущен. HTML файл будет обновляться каждые 10 минут.");
